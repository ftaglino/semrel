...
*/		return qss;
	...
	public void updateRequest(String queryString, Object knowledgeSourceRef) {
		UpdateRequest request = UpdateFactory.create(queryString);
		//UpdateProcessor proc = UpdateExecutionFactory.createRemote(request, (String)knowledgeSourceRef);
		//proc.execute();
	}
}
