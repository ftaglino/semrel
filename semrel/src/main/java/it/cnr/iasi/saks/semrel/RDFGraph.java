...
//		System.out.println("countAllNodes");
	...
	public void createGraph(String graph) {
		SPARQLQueryCollector.createGraph(this.getSc(), this.getKnowledgeResourceRef(), graph);
	}
	
	public void storeTriples(Set<Triple> triples) {
		SPARQLQueryCollector.storeTriples(this.getSc(), this.getKnowledgeResourceRef(), this.getGraph(), triples);
	}
