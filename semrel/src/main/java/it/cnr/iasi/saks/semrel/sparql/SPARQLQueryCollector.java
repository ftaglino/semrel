...
*/	
	...
	/**
	 * The method creates a graph
	 * @param sc
	 * @param knowledgeSourceRef
	 * @param graph
	 */
	public static void createGraph(SPARQLConnector sc, Object knowledgeSourceRef, String graph) {
		String queryString = "CREATE GRAPH <"+graph+"> ";
//		System.out.println(queryString);
		sc.updateRequest(queryString, knowledgeSourceRef);		
	}
	
	/**
	 * The method stores some triples in the graph.
	 * @param sc
	 * @param knowledgeSourceRef
	 * @param graph
	 * @param triples
	 */
	public static void storeTriples(SPARQLConnector sc, Object knowledgeSourceRef, String graph, Set<Triple> triples) {
		String dataToInsert = "";
		for(Triple t:triples) {
			dataToInsert += "<"+t.getSubject()+"> <"+t.getPredicate()+"> <"+t.getObject()+"> . "; 
		}
		dataToInsert = dataToInsert.substring(0, dataToInsert.length()-3);
		
		String queryString = "INSERT DATA " +
	 			"{ GRAPH <"+graph+"> {"+ dataToInsert +"}}";
